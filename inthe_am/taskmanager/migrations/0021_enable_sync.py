...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """ Set all stores to enabled.

        This migration isn't strictly necessary in most situations, but
        for users testing this feature in SQLite will bump into 
        many problems relating to defaults being improperly set:

            http://south.aeracode.org/ticket/578

        """

        for store in orm.TaskStore.objects.all():
