...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.sync_enabled'
        db.add_column(u'taskmanager_taskstore', 'sync_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.sync_enabled'
        db.delete_column(u'taskmanager_taskstore', 'sync_enabled')
