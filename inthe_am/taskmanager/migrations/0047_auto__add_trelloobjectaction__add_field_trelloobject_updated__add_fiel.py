...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'taskmanager_trelloobject', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 6, 30, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TrelloObject.created'
        db.add_column(u'taskmanager_trelloobject', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 6, 30, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TrelloObject.updated'
        db.delete_column(u'taskmanager_trelloobject', 'updated')

        # Deleting field 'TrelloObject.created'
        db.delete_column(u'taskmanager_trelloobject', 'created')
