...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.created'
        db.add_column(u'taskmanager_taskstore', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 4, 19, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'TaskStore.updated'
        db.add_column(u'taskmanager_taskstore', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 4, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.created'
        db.delete_column(u'taskmanager_taskstore', 'created')

        # Deleting field 'TaskStore.updated'
        db.delete_column(u'taskmanager_taskstore', 'updated')
