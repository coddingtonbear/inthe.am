...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrelloObject.log'
        db.add_column(u'taskmanager_trelloobject', 'log',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrelloObject.log'
        db.delete_column(u'taskmanager_trelloobject', 'log')
