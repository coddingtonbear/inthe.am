...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrelloObject.last_action'
        db.add_column(u'taskmanager_trelloobject', 'last_action',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrelloObject.last_action'
        db.delete_column(u'taskmanager_trelloobject', 'last_action')
