...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'KanbanBoard.column_names'
        db.delete_column(u'taskmanager_kanbanboard', 'column_names')

        # Adding field 'KanbanBoard.columns'
        db.add_column(u'taskmanager_kanbanboard', 'columns',
                      self.gf('django.db.models.fields.TextField')(default='[{"name": "Ready"}, {"name": "Doing"}, {"name": "Done"}]'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'KanbanBoard.column_names'
        db.add_column(u'taskmanager_kanbanboard', 'column_names',
                      self.gf('django.db.models.fields.TextField')(default='Ready|Doing|Done'),
                      keep_default=False)

        # Deleting field 'KanbanBoard.columns'
        db.delete_column(u'taskmanager_kanbanboard', 'columns')
