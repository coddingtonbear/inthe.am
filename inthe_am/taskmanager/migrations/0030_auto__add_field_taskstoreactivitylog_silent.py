...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStoreActivityLog.silent'
        db.add_column(u'taskmanager_taskstoreactivitylog', 'silent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStoreActivityLog.silent'
        db.delete_column(u'taskmanager_taskstoreactivitylog', 'silent')
