...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskStoreActivity.error'
        db.delete_column(u'taskmanager_taskstoreactivity', 'error')

        # Adding field 'TaskStoreActivity.metadata'
        db.add_column(u'taskmanager_taskstoreactivity', 'metadata',
                      self.gf('jsonfield.fields.JSONField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskStoreActivity.error'
        db.add_column(u'taskmanager_taskstoreactivity', 'error',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'TaskStoreActivity.metadata'
        db.delete_column(u'taskmanager_taskstoreactivity', 'metadata')
