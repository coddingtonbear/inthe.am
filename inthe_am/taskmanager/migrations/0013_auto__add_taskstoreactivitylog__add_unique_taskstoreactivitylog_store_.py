...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskStoreActivityLog'
        db.create_table(u'taskmanager_taskstoreactivitylog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='log_entries', to=orm['taskmanager.TaskStore'])),
            ('md5hash', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ...
        db.send_create_signal(u'taskmanager', ['TaskStoreActivityLog'])

        # Adding unique constraint on 'TaskStoreActivityLog', fields ['store', 'md5hash']
        db.create_unique(u'taskmanager_taskstoreactivitylog', ['store_id', 'md5hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaskStoreActivityLog', fields ['store', 'md5hash']
        db.delete_unique(u'taskmanager_taskstoreactivitylog', ['store_id', 'md5hash'])

        # Deleting model 'TaskStoreActivityLog'
        db.delete_table(u'taskmanager_taskstoreactivitylog')
