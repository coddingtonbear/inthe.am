...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BugwarriorConfig.created'
        db.delete_column(u'taskmanager_bugwarriorconfig', 'created')

        # Deleting field 'BugwarriorConfig.updated'
        db.delete_column(u'taskmanager_bugwarriorconfig', 'updated')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BugwarriorConfig.created'
        raise RuntimeError("Cannot reverse this migration. 'BugwarriorConfig.created' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BugwarriorConfig.created'
        db.add_column(u'taskmanager_bugwarriorconfig', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'BugwarriorConfig.updated'
        raise RuntimeError("Cannot reverse this migration. 'BugwarriorConfig.updated' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BugwarriorConfig.updated'
        db.add_column(u'taskmanager_bugwarriorconfig', 'updated',
