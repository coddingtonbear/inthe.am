...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'taskmanager_taskattachment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachments', to=orm['taskmanager.TaskStore'])),
        ...
        db.send_create_signal(u'taskmanager', ['TaskAttachment'])


    def backwards(self, orm):
        # Deleting model 'TaskAttachment'
        db.delete_table(u'taskmanager_taskattachment')
