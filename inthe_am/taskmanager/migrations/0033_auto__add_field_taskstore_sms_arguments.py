...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.sms_arguments'
        db.add_column(u'taskmanager_taskstore', 'sms_arguments',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.sms_arguments'
        db.delete_column(u'taskmanager_taskstore', 'sms_arguments')
