...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaskStoreActivity'
        db.create_table(u'taskmanager_taskstoreactivity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='syncs', to=orm['taskmanager.TaskStore'])),
            ('activity', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('error', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('duration_seconds', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('started', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('taskmanager', ['TaskStoreActivity'])


    def backwards(self, orm):
        # Deleting model 'TaskStoreActivity'
        db.delete_table(u'taskmanager_taskstoreactivity')
    ...
    models = {
        ...
        'taskmanager.taskstoreactivity': {
            ...
            'duration_seconds': ('django.db.models.fields.PositiveIntegerField', [], {}),
