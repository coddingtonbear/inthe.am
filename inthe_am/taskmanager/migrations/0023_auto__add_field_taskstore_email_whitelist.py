...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.email_whitelist'
        db.add_column(u'taskmanager_taskstore', 'email_whitelist',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.email_whitelist'
        db.delete_column(u'taskmanager_taskstore', 'email_whitelist')
