...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.sync_permitted'
        db.add_column(u'taskmanager_taskstore', 'sync_permitted',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.sync_permitted'
        db.delete_column(u'taskmanager_taskstore', 'sync_permitted')
