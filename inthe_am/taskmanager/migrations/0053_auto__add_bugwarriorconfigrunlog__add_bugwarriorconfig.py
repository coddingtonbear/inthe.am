...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BugwarriorConfigRunLog'
        db.create_table(u'taskmanager_bugwarriorconfigrunlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('config', self.gf('django.db.models.fields.related.ForeignKey')(related_name='run_logs', to=orm['taskmanager.BugwarriorConfig'])),
            ('success', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('output', self.gf('django.db.models.fields.TextField')()),
            ('stack_trace', self.gf('django.db.models.fields.TextField')()),
            ('started', self.gf('django.db.models.fields.DateTimeField')()),
            ('finished', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal('taskmanager', ['BugwarriorConfigRunLog'])

        # Adding model 'BugwarriorConfig'
        db.create_table(u'taskmanager_bugwarriorconfig', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='bugwarrior_configs', to=orm['taskmanager.TaskStore'])),
            ('serialized_config', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('taskmanager', ['BugwarriorConfig'])


    def backwards(self, orm):
        # Deleting model 'BugwarriorConfigRunLog'
        db.delete_table(u'taskmanager_bugwarriorconfigrunlog')

        # Deleting model 'BugwarriorConfig'
        db.delete_table(u'taskmanager_bugwarriorconfig')
