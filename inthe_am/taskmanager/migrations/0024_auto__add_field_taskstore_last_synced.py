...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.last_synced'
        db.add_column(u'taskmanager_taskstore', 'last_synced',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.last_synced'
        db.delete_column(u'taskmanager_taskstore', 'last_synced')
