...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.secret_id'
        db.add_column(u'taskmanager_taskstore', 'secret_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.secret_id'
        db.delete_column(u'taskmanager_taskstore', 'secret_id')
