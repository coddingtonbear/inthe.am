...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskStore.trello_auth_token'
        db.alter_column(u'taskmanager_taskstore', 'trello_auth_token', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'TaskStore.trello_auth_token'
        db.alter_column(u'taskmanager_taskstore', 'trello_auth_token', self.gf('django.db.models.fields.CharField')(max_length=32))
