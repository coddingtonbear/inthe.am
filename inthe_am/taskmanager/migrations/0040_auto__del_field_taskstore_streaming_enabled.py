...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskStore.streaming_enabled'
        db.delete_column(u'taskmanager_taskstore', 'streaming_enabled')


    def backwards(self, orm):
        # Adding field 'TaskStore.streaming_enabled'
        db.add_column(u'taskmanager_taskstore', 'streaming_enabled',
