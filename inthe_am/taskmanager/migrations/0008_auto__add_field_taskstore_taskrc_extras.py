...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.taskrc_extras'
        db.add_column(u'taskmanager_taskstore', 'taskrc_extras',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.taskrc_extras'
        db.delete_column(u'taskmanager_taskstore', 'taskrc_extras')
