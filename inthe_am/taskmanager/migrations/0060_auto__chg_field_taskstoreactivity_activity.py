...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskStoreActivity.activity'
        db.alter_column(u'taskmanager_taskstoreactivity', 'activity', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'TaskStoreActivity.activity'
        db.alter_column(u'taskmanager_taskstoreactivity', 'activity', self.gf('django.db.models.fields.CharField')(max_length=100))
