...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.trello_local_head'
        db.add_column(u'taskmanager_taskstore', 'trello_local_head',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.trello_local_head'
        db.delete_column(u'taskmanager_taskstore', 'trello_local_head')
