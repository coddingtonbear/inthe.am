...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'taskmanager_usermetadata', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='metadata', unique=True, to=orm['auth.User'])),
            ('tos_version', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('tos_accepted', self.gf('django.db.models.fields.DateTimeField')(default=None)),
        ))
        db.send_create_signal(u'taskmanager', ['UserMetadata'])


    def backwards(self, orm):
        # Deleting model 'UserMetadata'
        db.delete_table(u'taskmanager_usermetadata')
    ...
    models = {
        ...
        u'taskmanager.usermetadata': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tos_accepted': ('django.db.models.fields.DateTimeField', [], {'default': 'None'}),
