...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskStore.sms_reply_enabled'
        db.delete_column(u'taskmanager_taskstore', 'sms_reply_enabled')

        # Adding field 'TaskStore.sms_replies'
        db.add_column(u'taskmanager_taskstore', 'sms_replies',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=9),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskStore.sms_reply_enabled'
        db.add_column(u'taskmanager_taskstore', 'sms_reply_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'TaskStore.sms_replies'
        db.delete_column(u'taskmanager_taskstore', 'sms_replies')
    ...
    models = {
        ...
        'taskmanager.kanbanboard': {
            'Meta': {'object_name': 'KanbanBoard', '_ormbases': ['taskmanager.TaskStore']},
            'columns': ('django.db.models.fields.TextField', [], {'default': '\'[{"name": "Ready"}, {"name": "Doing"}, {"name": "Done"}]\''}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'taskstore_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['taskmanager.TaskStore']", 'unique': 'True', 'primary_key': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '36', 'blank': 'True'})
        },
        'taskmanager.kanbanmembership': {
            'Meta': {'object_name': 'KanbanMembership'},
            'accepted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitee_email': ('django.db.models.fields.EmailField', [], {'db_index': 'True', 'max_length': '254', 'blank': 'True'}),
            'kanban_board': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'memberships'", 'to': "orm['taskmanager.KanbanBoard']"}),
