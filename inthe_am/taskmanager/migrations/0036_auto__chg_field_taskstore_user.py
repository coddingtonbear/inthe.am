...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaskStore.user'
        db.alter_column(u'taskmanager_taskstore', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'TaskStore.user'
        raise RuntimeError("Cannot reverse this migration. 'TaskStore.user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'TaskStore.user'
        db.alter_column(u'taskmanager_taskstore', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
