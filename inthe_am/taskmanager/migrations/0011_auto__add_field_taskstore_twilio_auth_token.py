...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.twilio_auth_token'
        db.add_column(u'taskmanager_taskstore', 'twilio_auth_token',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.twilio_auth_token'
        db.delete_column(u'taskmanager_taskstore', 'twilio_auth_token')
    ...
    models = {
        ...
        u'taskmanager.taskstore': {
            ...
            'twilio_auth_token': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
