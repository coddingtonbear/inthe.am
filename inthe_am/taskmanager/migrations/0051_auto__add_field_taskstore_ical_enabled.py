...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaskStore.ical_enabled'
        db.add_column(u'taskmanager_taskstore', 'ical_enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaskStore.ical_enabled'
        db.delete_column(u'taskmanager_taskstore', 'ical_enabled')
