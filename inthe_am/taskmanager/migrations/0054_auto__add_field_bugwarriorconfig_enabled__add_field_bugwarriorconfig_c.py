...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BugwarriorConfig.enabled'
        db.add_column(u'taskmanager_bugwarriorconfig', 'enabled',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'BugwarriorConfig.created'
        db.add_column(u'taskmanager_bugwarriorconfig', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 7, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'BugwarriorConfig.updated'
        db.add_column(u'taskmanager_bugwarriorconfig', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 7, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BugwarriorConfig.enabled'
        db.delete_column(u'taskmanager_bugwarriorconfig', 'enabled')
