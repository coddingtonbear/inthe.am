...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserMetadata.colorscheme'
        db.add_column(u'taskmanager_usermetadata', 'colorscheme',
                      self.gf('django.db.models.fields.CharField')(default='dark-yellow-green.theme', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserMetadata.colorscheme'
        db.delete_column(u'taskmanager_usermetadata', 'colorscheme')
