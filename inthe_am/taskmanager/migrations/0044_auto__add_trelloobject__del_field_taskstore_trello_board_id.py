...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TrelloObject'
        db.create_table(u'taskmanager_trelloobject', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('store', self.gf('django.db.models.fields.related.ForeignKey')(related_name='trello_objects', to=orm['taskmanager.TaskStore'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['taskmanager.TrelloObject'])),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('meta', self.gf('jsonfield.fields.JSONField')()),
        ))
        db.send_create_signal('taskmanager', ['TrelloObject'])
    ...
    def backwards(self, orm):
        # Deleting model 'TrelloObject'
        db.delete_table(u'taskmanager_trelloobject')
