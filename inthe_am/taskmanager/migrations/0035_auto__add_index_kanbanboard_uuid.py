...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'KanbanBoard', fields ['uuid']
        db.create_index(u'taskmanager_kanbanboard', ['uuid'])


    def backwards(self, orm):
        # Removing index on 'KanbanBoard', fields ['uuid']
        db.delete_index(u'taskmanager_kanbanboard', ['uuid'])
