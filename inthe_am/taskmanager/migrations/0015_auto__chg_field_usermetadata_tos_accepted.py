...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserMetadata.tos_accepted'
        db.alter_column(u'taskmanager_usermetadata', 'tos_accepted', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserMetadata.tos_accepted'
        raise RuntimeError("Cannot reverse this migration. 'UserMetadata.tos_accepted' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'UserMetadata.tos_accepted'
        db.alter_column(u'taskmanager_usermetadata', 'tos_accepted', self.gf('django.db.models.fields.DateTimeField')())
