...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrelloObject.deleted'
        db.add_column(u'taskmanager_trelloobject', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrelloObject.deleted'
        db.delete_column(u'taskmanager_trelloobject', 'deleted')
