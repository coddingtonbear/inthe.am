...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskStoreActivity.statistics_version'
        db.delete_column(u'taskmanager_taskstoreactivity', 'statistics_version')

        # Adding field 'TaskStoreActivity.metadata_version'
        db.add_column(u'taskmanager_taskstoreactivity', 'metadata_version',
                      self.gf('django.db.models.fields.CharField')(default='v2', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskStoreActivity.statistics_version'
        db.add_column(u'taskmanager_taskstoreactivity', 'statistics_version',
                      self.gf('django.db.models.fields.CharField')(default='v2', max_length=10),
                      keep_default=False)

        # Deleting field 'TaskStoreActivity.metadata_version'
        db.delete_column(u'taskmanager_taskstoreactivity', 'metadata_version')
    ...
    models = {
        ...
        'taskmanager.taskstoreactivity': {
            ...
            'duration_seconds': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'message': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'metadata': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'metadata_version': ('django.db.models.fields.CharField', [], {'default': "'v2'", 'max_length': '10'}),
